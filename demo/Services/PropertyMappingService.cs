...
namespace MyDemo.Services
{
    ...
    public class PropertyMappingService : IPropertyMappingService
    {
        ...
        //映射关系列表
        //不能在 IList<T> 中直接使用泛型了，不支持泛型解析 IList<PropertyMapping<TSource, TDestination>>
        //因此需要写一个接口 IPropertyMapping，让PropertyMapping 实现这个接口
